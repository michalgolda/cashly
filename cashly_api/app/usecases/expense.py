...
class ExportExpensesUseCase(UseCase[ExportExpensesUseCaseInput, ExportExpensesUseCaseOutput]):
  def __init__(self, expense_repo: ExpenseRepository, expenses_exporter: Exporter) -> None:
    self._expense_repo = expense_repo
  ...
  def execute(self, input: ImportExpensesUseCaseInput) -> NoReturn:
    ...
    for expense in parsed_expenses:
      ...
      if expense_category_name:
        existing_expense_category = self._expense_category_repo.get_by_name_and_user_id(
