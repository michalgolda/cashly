...
export function listOptionsReducer(state, action) {
    switch (action.type) {
            ...
            return {
                ...
                expenses: state.fetchedExpenes
                    .filter((expense) => {
                        ...
                        if (state.filterParams.category === '')
                    ...
                    .filter((expense) => {
                        ...
                        return (
                            expense.realised_date ===
                            state.filterParams.realised_date
                        )
                    }),
            }
            ...
            return {
                ...
                expenses: state.expenses.sort((firstExpense, secondExpense) => {
                    if (state.sortParams.amount === 'ascending') {
                        ...
                        if (firstExpense.amount < secondExpense.amount)
                            return -1
                        return 0
                    }
                    ...
                    if (state.sortParams.realised_date === 'ascending') {
                        const firstExpenseRealisedDate = moment(
                            firstExpense.realised_date
                        )
                        ...
                        if (
                            firstExpenseRealisedDate > secondExpenseRealisedDate
                        )
                            return 1
                        if (
                            firstExpenseRealisedDate < secondExpenseRealisedDate
